...
Follow these 2 link to open the dedicated Google spreadsheet and a simple dashboard for live updates on the data you are collecting!
...
***Question 5: Comparing the distribution of tree height, DBH, and tree count you collected with what is available for Malcolm Knapp, provide three examples of how you could improve the representativeness of your ground-sampled data to capture the variability of site and forest conditions in Malcolm Knapp.***